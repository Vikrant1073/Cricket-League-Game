...
class Ui_evaluate_team(object):
    ...
    def setupUi(self, evaluate_team):
        ...
        evaluate_team.resize(618, 540)
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        evaluate_team.setFont(font)
        evaluate_team.setStyleSheet("\n"
"background-color: rgb(255, 254, 229);")
        self.label = QtWidgets.QLabel(evaluate_team)
        self.label.setGeometry(QtCore.QRect(170, 20, 261, 51))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        ...
        self.selectteam_cb.setGeometry(QtCore.QRect(230, 80, 138, 25))
        font = QtGui.QFont()
        ...
        self.selectteam_cb.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.selectteam_cb.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"font: 75 italic 10pt \"Century Gothic\";")
        self.selectteam_cb.setMaxVisibleItems(15)
        self.selectteam_cb.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToMinimumContentsLengthWithIcon)
        self.selectteam_cb.setObjectName("selectteam_cb")
        self.selectteam_cb.addItem("")
        self.line = QtWidgets.QFrame(evaluate_team)
        self.line.setGeometry(QtCore.QRect(40, 110, 551, 41))
        ...
        self.label_3.setGeometry(QtCore.QRect(400, 150, 81, 21))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.calcscore_btn.setGeometry(QtCore.QRect(240, 460, 141, 31))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(10)
        self.calcscore_btn.setFont(font)
        self.calcscore_btn.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.calcscore_btn.setStyleSheet("background-color: rgb(213, 254, 255);")
        ...
        self.players_lw.setGeometry(QtCore.QRect(80, 180, 191, 251))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.scores_lw.setGeometry(QtCore.QRect(340, 180, 191, 251))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.scores_lw.setLayoutDirection(QtCore.Qt.RightToLeft)
    ...
    def retranslateUi(self, evaluate_team):
        ...
        self.label.setText(_translate("evaluate_team", "Find how many points u got"))
    ...
    def final_score(self):
        ...
        for k in value:
            ts+=k[0]
        self.score_screen.finalscore.setText(str(ts))
