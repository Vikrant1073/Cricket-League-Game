...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(349, 238)
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(90, 40, 161, 40))
        font = QtGui.QFont()
        ...
        self.openbtn.setGeometry(QtCore.QRect(130, 150, 93, 49))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Find Your Team"))
        self.openbtn.setText(_translate("Dialog", "Done"))
